node{
    ...
    stage('SCM Checkout'){
        git credentialsId: 'GIT_CREDENTIALS', url:  'https://github.com/chandpra92/k8s-jenkins-springboot.git',branch: 'master'
    }
    ...
    stage('Build Docker Image'){
        sh 'docker build -t chandanp/spring-boot-mongo .'
    }
